...
// display the data with single line
document.getElementsByClassName("str-to-obj")[0].innerHTML = infoObj.age;

// Object convert to JSON string
var infoString = JSON.stringify(infoObj);
console.log(infoString);
// display the data with single line
document.getElementsByClassName("obj-to-str")[0].innerHTML = infoString;
